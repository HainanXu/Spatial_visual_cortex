...
We combine the 42 dataframes and convert them into ppp object. After that,we compute the first order intensity as well as the nearest neighbor distance distribution.
```{R message=FALSE}
